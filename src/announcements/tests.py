...
class AnnouncementTestCase(TestCase):
    ...
    def test_model(self):
        ...
        self.assertEqual(announcement.expiration_timestamp, datetime.datetime(2100, 10, 1, 0, 0, tzinfo=datetime.timezone.utc))
    ...
    def test_recent_list(self):
        announcements = self.c.get('/api/announcements/recent/', query_params={'n': 1}).data
    ...
    def test_create(self):
        response = self.c.post('/api/announcements/', {
