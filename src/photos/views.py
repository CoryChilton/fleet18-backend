            ...
            try:
                ...
                if exif:
                    ...
                    if 'DateTime' in exif_data:
                        ...
                        photo_taken_timestamp = datetime.strptime(photo_taken_timestamp_str, '%Y:%m:%d %H:%M:%S')
                        photo_taken_timestamp = photo_taken_timestamp.replace(tzinfo=ZoneInfo('America/Los_Angeles'))
